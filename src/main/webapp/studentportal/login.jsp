...
<body>
    ...
    <div class="login-card">
        ...
        <div class="card-body">
            ...
            <div class="info-block">
                <strong>For Registered Student:</strong> Check your registered email ID for OTP to login to the student portal.
            </div>

            <!-- Click launches the modal overlay instead of standard link -->
            <div class="create-account">
                <a href="#" onclick="openRegisterModal(event)">Create an account</a>
            </div>
    ...
    <script>
        ...
        function handleRegistrationSubmit(e) {
            ...
            const validEnrollments = ['226170307001', '226170307002', '226170307003'];
