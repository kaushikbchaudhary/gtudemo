    ...
    <style>
        ...
        * {
        ...
        .recovery-card {
            background: #ffffff;
            width: 100%;
            max-width: 650px; /* Spacious width to fit layout tables and agreement text */
        ...
        .green-link:hover {
            text-decoration: underline;
            color: #157347; /* Darker green hover */
        }
        ...
        .agreement-block {
            ...
            margin-bottom: 20px;
            max-height: 150px;
            overflow-y: auto; /* scrollable for legal text ease */
        }
...
<body>
    ...
    <div class="recovery-card">
        ...
        <div class="card-header">
            ...
            <h2>GUJARAT TECHNOLOGICAL UNIVERSITY<br><span style="font-size: 14px; font-weight: normal; opacity: 0.9;">Forgot Password - Student Recovery Portal</span></h2>
        </div>
            ...
            <form id="recoveryForm" onsubmit="handlePasswordRecovery(event)">
                ...
                <table class="details-table" id="detailsTableContainer">
                    ...
                    <tr>
                        <th>Mobile</th>
                        <td>
                            <span id="mobileText"><%= student.getMobile() %></span>
                            <a href="#" class="inline-link" onclick="alert('Please contact your college administrator to submit a request for updating your mobile number in the GTU database.')">Click Here, If it is not your mobile no. or you want to change your mobile no in GTU database.</a>
                            <div class="note-subtext">(You will receive your password on this mobile no.)</div>
                        </td>
                    </tr>
                </table>
                ...
                <div class="agreement-block" id="agreementContainer">
                    <label class="checkbox-container">
                        ...
                        <span class="checkbox-label">
                            I agree that I have submitted my own detail, the detail are right as per my confirmation. If this information will be wrong then I may be bound with legal affairs or advocate illegal activity. I am also confirmed that I register here for my own re-check/re-assess, if i found with registering other's information, then GTU can claim illegal activity to me. I must use every effort to keep my password safe and should not disclose it to any other person. I shall also not permit, either directly or indirectly, any other person to utilize my User ID or password. GTU not responsible, if any other person misuses the service by logging into your account.
                        </span>
                    </label>
                </div>
                ...
                <div class="institute-update-section" id="instituteLinkContainer">
                    <a href="updatemobilenoemailinst.jsp?Mapreg=zKGEb3QbJ1%2bDaxwV4b7Z0A%3d%3d&stname=eNxmwPxykce%2fpzsRxSb2KzCHJbh4eiCRf0T0zdsVY2A%3d&enrollmentNo=<%= student.getEnrollmentNo() %>" class="green-link">Click Here</a>, To Update Mobile No. and Email-Id by Institute
                </div>
                ...
                <div class="captcha-section-wrapper" id="captchaSectionContainer">
                    ...
                    <div class="captcha-row">
                        <div class="captcha-input">
                            <input type="text" class="form-control" id="recoveryCaptchaInput" placeholder="Captcha Code" required autocomplete="off">
                        </div>
                        <div class="captcha-box" id="recoveryCaptchaText">3985</div>
                        <a href="#" class="refresh-icon" onclick="refreshRecoveryCaptcha(event)" title="Refresh Captcha">&#8635;</a>
                    </div>
                </div>

                <!-- Action Button Row -->
                <div class="button-row">
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='login.jsp'">Previous</button>
                    <button type="submit" class="btn btn-primary" id="recoverySubmitBtn">Get Password</button>
                </div>
